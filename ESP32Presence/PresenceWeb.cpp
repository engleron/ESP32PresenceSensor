...
void sendIntegrationSection(bool isSetup) {
  ...
  server.sendContent(
    ...
    "Find under HA Settings &rarr; Entities.<br><br>"
    "<strong>HomeKit lights (e.g. Leviton Decora Smart Gen2):</strong> In HA add the "
    "<em>HomeKit Controller</em> integration (Settings &rarr; Devices &amp; Services &rarr; "
    "Add Integration &rarr; HomeKit Controller), pair your Leviton there, then enter its "
    "HA entity ID here. No Apple hub or ENABLE_HOMEKIT compile flag needed.</span>"
