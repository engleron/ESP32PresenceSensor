...
void initHomeKit() {
  ...
  homeSpan.setLogLevel(0);                          // level 0: quiet. Level 1 floods the serial
                                                    // port with a blocking "In Get Characteristics"
                                                    // print on every HAP poll, starving the loop
                                                    // task during the controller's high-rate polling.
